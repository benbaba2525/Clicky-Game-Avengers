...
3.The application should keep track of the user's score. The user's score should be incremented when clicking an image for the first time.<br> The user's score should be reset to 0 if they click the same image more than once.
